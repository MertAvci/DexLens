...
struct FontPreviewView: View {
    ...
    private var typographySection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            FontTypographyRow(font: Font.custom(RobotoWeight.bold.fontName, size: 34), label: "Large Title", size: "34pt")
            ...
            Divider()
            FontTypographyRow(font: Font.custom(RobotoWeight.regular.fontName, size: 15), label: "Subheadline", size: "15pt")
            FontTypographyRow(font: Font.custom(RobotoWeight.medium.fontName, size: 15), label: "Subheadline Bold", size: "15pt")
            Divider()
            FontTypographyRow(font: Font.custom(RobotoWeight.regular.fontName, size: 13), label: "Footnote", size: "13pt")
            FontTypographyRow(font: Font.custom(RobotoWeight.medium.fontName, size: 13), label: "Footnote Bold", size: "13pt")
            Divider()
            FontTypographyRow(font: Font.custom(RobotoWeight.regular.fontName, size: 12), label: "Caption 1", size: "12pt")
            FontTypographyRow(font: Font.custom(RobotoWeight.regular.fontName, size: 11), label: "Caption 2", size: "11pt")
        }
    }
}
